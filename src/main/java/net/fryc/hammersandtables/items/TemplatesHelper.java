...
public class TemplatesHelper {
    ...
    static{
        ...
        GOLDEN_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", new Identifier(HammersAndTables.MOD_ID,"golden_upgrade"))).formatted(TITLE_FORMATTING);
        GOLDEN_UPGRADE_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.golden_upgrade.applies_to"))).formatted(DESCRIPTION_FORMATTING);
        GOLDEN_UPGRADE_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.golden_upgrade.ingredients"))).formatted(DESCRIPTION_FORMATTING);
        GOLDEN_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.golden_upgrade.base_slot_description")));
        GOLDEN_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.golden_upgrade.additions_slot_description")));

        IRON_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", new Identifier(HammersAndTables.MOD_ID,"iron_upgrade"))).formatted(TITLE_FORMATTING);
        IRON_UPGRADE_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.iron_upgrade.applies_to"))).formatted(DESCRIPTION_FORMATTING);
        IRON_UPGRADE_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.iron_upgrade.ingredients"))).formatted(DESCRIPTION_FORMATTING);
        IRON_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.iron_upgrade.base_slot_description")));
        IRON_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", new Identifier(HammersAndTables.MOD_ID,"smithing_template.iron_upgrade.additions_slot_description")));
