...
public abstract class ModForgingScreenHandlerOld extends ScreenHandler {
    ...
    protected final Inventory input = new SimpleInventory(4) {
        public void markDirty() {
            super.markDirty();
            ModForgingScreenHandlerOld.this.onContentChanged(this);
        }
    };
    ...
    public ModForgingScreenHandlerOld(@Nullable ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(type, syncId);
        ...
        this.addSlot(new Slot(this.input, 3, 105, 26){
            public boolean canTakeItems(PlayerEntity playerEntity) {
                return !ModForgingScreenHandlerOld.this.canTakeOutput(playerEntity, this.hasStack());
            }
        ...
        this.addSlot(new Slot(this.output, 2, 134, 47) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ModForgingScreenHandlerOld.this.onTakeOutput(player, stack);
            }
        });
