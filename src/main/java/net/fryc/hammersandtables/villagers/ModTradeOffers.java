...
public class ModTradeOffers extends TradeOffers{
    ...
    public static final Map<VillagerProfession, Int2ObjectMap<Factory[]>> MOD_PROFESSION_TO_LEVELED_TRADE = (Map) Util.make(Maps.newHashMap(), (map) -> {
        ...
        map.put(VillagerProfession.LIBRARIAN, copyToFastUtilMap(ImmutableMap.of(1, new Factory[]{new BuyItemFactory(Items.PAPER, 24, 16, 2), new SellItemFactory(Blocks.BOOKSHELF, 9, 1, 12, 1)},
                2, new Factory[]{new BuyItemFactory(Items.BOOK, 4, 12, 10), new EnchantBookFactory(5), new SellItemFactory(Items.LANTERN, 1, 1, 5)},
                3, new Factory[]{new BuyItemFactory(Items.INK_SAC, 5, 12, 20), new EnchantBookFactory(10), new SellItemFactory(Items.GLASS, 1, 4, 10)},
                4, new Factory[]{new BuyItemFactory(Items.WRITABLE_BOOK, 2, 12, 30), new EnchantBookFactory(15), new SellItemFactory(Items.CLOCK, 5, 1, 15), new SellItemFactory(Items.COMPASS, 4, 1, 15)},
                5, new Factory[]{new SellItemFactory(Items.NAME_TAG, 20, 1, 30), new EnchantBookFactory(30)})));
